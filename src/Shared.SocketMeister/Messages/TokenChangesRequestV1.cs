...
namespace SocketMeister.Messages
{
    ...
    internal class TokenChangesRequestV1 : MessageBase, IMessage
    {
        ...
        public TokenChangesRequestV1(byte[] ChangeBytes) : base(MessageType.SubscriptionChangesNotificationV1)
        {
        ...
        public TokenChangesRequestV1(BinaryReader Reader) : base(MessageType.SubscriptionChangesNotificationV1)
        {
