...
namespace SocketMeister.Messages
{
    ...
    internal class TokenChangesRequestV1 : MessageBase, IMessage
    {
        ...
        public TokenChangesRequestV1(byte[] ChangeBytes) : base(MessageTypes.SubscriptionChangesRequestV1) 
        {
        ...
        public TokenChangesRequestV1(BinaryReader Reader) : base(MessageTypes.SubscriptionChangesRequestV1)
        {
