...
namespace SocketMeister.Messages
{
    ...
    internal class TokenChangesRequestV1 : MessageBase, IMessage
    {
        ...
        public TokenChangesRequestV1(byte[] ChangeBytes) : base(MessageTypes.SubscriptionChangesNotificationV1) 
        {
        ...
        public TokenChangesRequestV1(BinaryReader Reader) : base(MessageTypes.SubscriptionChangesNotificationV1)
        {
