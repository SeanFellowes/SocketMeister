...
namespace SocketMeister.Messages
{
    ...
    internal partial class MessageV2 : MessageBase
    {
    ...
    /// </summary>
    internal partial class MessageV2 : MessageBase, IMessage
    {
        //  MESSAGE ID
        ...
        /// <param name="IsRequest">Whether the message is a request. Requests require a response from the user program.</param>
        /// <param name="IsLongPolling">The maximum number of milliseconds to wait for a response before timing out.</param>
        public MessageV2(object[] Parameters, int TimeoutMilliseconds, bool IsRequest, bool IsLongPolling = false) : base(MessageTypes.MessageV2)
        {
        ...
        internal MessageV2(BinaryReader bR) : base(MessageTypes.MessageV2)
        {
            _messageId = bR.ReadInt64();
            _timeoutMilliseconds = bR.ReadInt32();
            _isLongPolling = bR.ReadBoolean();
            _isRequest = bR.ReadBoolean();
        ...
        /// <summary>
        /// Whether the message is a request. Requests require a response from the calling program code
        /// </summary>
        public bool IsRequest
        {
            get { lock (Lock) { return _isRequest; } }
        }
        ...
        /// <summary>
        /// Identifier assigned to this message when it was created (usually when created at the client)
        /// </summary>
        ...
        /// <summary>
        /// Whether the method SendReceive(MessageV2 Message) should continue
        /// </summary>
