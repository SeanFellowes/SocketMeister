...
namespace SocketMeister.Messages
{
    ...
    internal class TokenChangesResponseV1 : MessageBase, IMessage
    {
        ...
        public TokenChangesResponseV1(List<TokenChange> Changes) : base(MessageType.TokenChangesResponseV1, messageId: 0, nameof(TokenChangesResponseV1))
        {
        ...
        public TokenChangesResponseV1(BinaryReader Reader) : base(MessageType.TokenChangesResponseV1, messageId: 0, nameof(TokenChangesResponseV1))
        {
